...
if page == "Home":
    ...
    st.image("https://cdn.pixabay.com/photo/2020/04/10/22/19/health-5021170_960_720.png", use_container_width=True)
    ...
    if st.button("Predict"):
        if not selected_symptoms:
            ...
            with st.spinner("Predicting..."):
                ...
                for i in range(3):
                    st.success(f"{i+1}. {predicted_classes[i]} ({probabilities[i]*100:.2f}%)")
